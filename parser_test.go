...
var setTests = []SetTest{
	...
	{
		desc:    "array is appended since index did not exist",
		json:    `{"top":[{"middle":[]}]}`,
		path:    []string{"top", "[1]", "second", "[0]"},
		setData: `"value"`,
		isFound: true,
		data:    `{"top":[{"middle":[]},{"second":["value"]}]}`,
	},
	{
		desc:    "array is padded and appended since index did not exist",
		json:    `{"top":[{"middle":[]}]}`,
		path:    []string{"top", "[3]", "fourth"},
		setData: `"value"`,
		isFound: true,
		data:    `{"top":[{"middle":[]},null,null,{"fourth":"value"}]}`,
	},
	{
		desc:    "array is padded including string handling",
		json:    `{"top":["middle"]}`,
		path:    []string{"top", "[3]", "fourth"},
		setData: `"value"`,
		isFound: true,
	...
	{
		desc:    "set indexed path on empty object with value and padded",
		json:    `{}`,
		path:    []string{"top", "[1]", "middle"},
		setData: `"value"`,
		isFound: true,
		data:    `{"top":[null,{"middle":"value"}]}`,
	},
	{
		desc:    "append on object with existing array",
		json:    `{"top":["one","two"]}`,
		path:    []string{"top", "[+]"},
		setData: `"three"`,
		isFound: true,
		data:    `{"top":["one","two","three"]}`,
	},
	{
		desc:    "prepend on object with existing array",
		json:    `{"top":["one","two"]}`,
		path:    []string{"top", "[-]"},
		setData: `"zero"`,
		isFound: true,
		data:    `{"top":["zero","one","two"]}`,
	},
	{
		desc:    "append on object without array",
		json:    `{"top":"value"}`,
		path:    []string{"top", "[+]"},
		setData: `"one"`,
		isFound: true,
	...
	{
		desc:    "append on object, create array",
		json:    `{"top":"value"}`,
		path:    []string{"middle", "[+]"},
		setData: `"value2"`,
		isFound: true,
		data:    `{"top":"value","middle":["value2"]}`,
	},
	{
		desc:    "prepend on object, create array",
		json:    `{"top":"value"}`,
		path:    []string{"middle", "[-]"},
		setData: `"value2"`,
		isFound: true,
	...
	{
		desc:    "append and prepend on object with array",
		json:    `{"top":["value"]}`,
		path:    []string{"top", "[+]", "middle", "[-]"},
		setData: `"value2"`,
		isFound: true,
		data:    `{"top":["value",{"middle":["value2"]}]}`,
	},
